...
// response code contains the cde for each status
class ResponseCode {
  // API status codes
  ...
  static const int INTERNAL_SERVER_ERROR = 503; // failure, crash happened in server side
...
class ResponseMessage {
  ...
  static const String FORBIDDEN = "Bad request, try again later"; // failure, api rejected the request
